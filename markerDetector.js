class MarkerDetector {
  constructor() {
    ...
    this.treshold.value = localStorage.getItem("markerTreshold") ?? 30;
  }

  updateTreshold(delta) {
    this.treshold.value = Number(this.treshold.value) + delta;
    localStorage.setItem("markerTreshold", this.treshold.value);
    console.log(this.treshold.value);
  }
